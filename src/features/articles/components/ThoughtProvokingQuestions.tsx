...
export const ThoughtProvokingQuestions: React.FC<ThoughtProvokingQuestionsProps> = ({ questions, isLoading = false }) => {
        ...
        <CardContent className="pt-6 pb-4">
          {questions.length === 0 && !isLoading ? (
            ...
            <div className="text-center py-8 text-gray-400">
              <p className="text-sm">Key questions will appear here as the article is generated...</p>
            </div>
          ) : (
