...
const Subscription = () => {
  ...
  const { user } = useAuth()
  const { isProUser, subscriptionTier, dailySearchCount, searchLimit, refreshSubscription } =
    useSubscription()
                ...
                <div className="space-y-4">
                  ...
                  {dailySearchCount >= searchLimit && (
                    <p className="text-red-600 text-sm">
                      You've reached your daily limit. Upgrade to Pro for unlimited searches!
                    </p>
                  )}
                  <Button onClick={handleCheckPayment} variant="outline" className="w-full mt-2">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          ...
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="outline" className="w-full" disabled={!isProUser}>
