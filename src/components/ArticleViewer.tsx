          ...
          <CardContent>
            {editingNotes ? (
              ...
              <div className="text-gray-600">
                {notes || (
                  <span className="italic text-gray-400">No notes added yet. Click Edit to add your thoughts.</span>
                )}
              </div>
            )}
          </CardContent>
            ...
            {editingTags ? (
              ...
              <div className="flex flex-wrap gap-2">
                {tags.length > 0 ? (
                  ...
                  <span className="italic text-gray-400">No tags added yet. Click Edit to organize this article.</span>
                )}
              </div>
            )}
          </CardContent>
